...
console.log('REPHRASED DATA SENDING AND RETRIEVAL QUESTIONS')
console.log('='.repeat(60))
console.log()

REPHRASED_QUESTIONS.forEach((q, i) => {
  console.log(`${i + 1}. [${q[0]}] ${q[1]}`)
})

console.log()
console.log('Total:', REPHRASED_QUESTIONS.length)
