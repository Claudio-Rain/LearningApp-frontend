...
**Q: Explain the key difference between containers and virtual machines.**
...
**Q: What are the trade-offs between VMs and containers (startup time, resource usage, security)?**
...
**Q: What's the relationship between a container image and a running container?**
...
**Q: Can you run multiple containers from one image? What's shared vs. isolated?**
...
**Q: What does "stateless by design" mean for containers?**
...
**Q: What happens when you pull an image (network and filesystem level)?**
...
**Q: What are volumes and why do you need them?**
...
**Q: What does it mean to "expose a port" and how does port mapping work?**
...
**Q: What is a base image and why does every Dockerfile start with FROM?**
...
**Q: What are environment variables and why pass them to containers?**
...
**Q: How do containers talk to each other and to the outside world?**
...
**Q: What's the difference between `docker-compose up` and `docker run`?**
...
**Q: What is the Docker daemon and why is it necessary?**
...
**Q: What are the security implications of a privileged Docker daemon?**
...
**Q: What's the difference between Docker and OCI?**
...
**Q: What states can a container be in and what triggers transitions between them?**
...
**Q: What happens to container data when stopped vs. removed?**
...
**Q: How do you diagnose and force-remove an unresponsive container?**
...
**Q: What's the difference between bind mounts and named volumes?**
...
**Q: How do you persist database data across container restarts?**
...
**Q: What Docker networking modes exist and when is the default bridge insufficient?**
...
**Q: How does DNS resolution work between containers on a user-defined bridge network?**
...
**Q: Write a production-ready Dockerfile for a Node.js app.**
...
**Q: How do you use images from a private registry in your Dockerfile and CI?**
...
**Q: Why is pinning by digest safer than pinning by tag?**
...
**Q: What's the difference between EXPOSE and -p flag?**
...
**Q: How do you pass environment variables to a container (--env, --env-file, baked)?**
...
**Q: Why is Docker build slow when only source files change?**
...
**Q: What are the risks of using ADD instead of COPY?**
...
**Q: What are the risks of storing secrets in .env files?**
...
**Q: What are the issues with bind-mounting the entire project root?**
...
**Q: Why does database data disappear after docker-compose down?**
...
**Q: What Linux kernel features enable container isolation (namespaces and cgroups)?**
...
**Q: Which namespaces do containers use and what's not isolated?**
...
**Q: How do cgroups enforce resource limits and trigger the OOM killer?**
...
**Q: Why does each RUN instruction create a layer? How does this affect image size and cache?**
...
**Q: What techniques minimize attack surface in container images?**
...
**Q: Should dependencies be baked into images or mounted at runtime?**
...
**Q: When should you move from Compose to Kubernetes?**
...
**Q: Containerized vs. managed stateful services (e.g., Redis) — trade-offs?**
...
**Q: Compare approaches to managing secrets: env vars, .env files, Docker secrets, external managers.**
...
**Q: Docker Hub vs. self-hosted vs. cloud registries — which to choose?**
