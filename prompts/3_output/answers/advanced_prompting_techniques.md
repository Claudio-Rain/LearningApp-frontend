...
**Q: L1 What is prompt engineering, and why does it matter?**
...
**Q: L1 When would you use zero-shot prompting?**
...
**Q: L1 How do zero-shot and few-shot prompting differ, and when does each work?**
...
**Q: L1 What's the difference between system prompts and user prompts?**
...
**Q: L1 Is longer always better for prompts? What are the downsides?**
...
**Q: L2 What is chain-of-thought prompting, and how does it work?**
...
**Q: L2 How does zero-shot CoT differ from few-shot CoT?**
...
**Q: L2 Why does step-by-step reasoning improve accuracy?**
...
**Q: L2 How do role prompts affect model output?**
...
**Q: L2 How do you balance role prompting's benefits and risks?**
...
**Q: L3 How would you summarize a long document within a small context window?**
...
**Q: L3 How would you extract structured JSON from unstructured text?**
...
**Q: L3 Few-shot examples or fine-tuning — when to choose each?**
...
**Q: L3 How do temperature and sampling settings affect your prompting strategy?**
...
**Q: L3 How many few-shot examples do you need?**
...
**Q: L3 How would you debug a model that's too verbose?**
...
**Q: L4 What is prompt leakage, and how do you prevent it?**
...
**Q: L4 What is prompt injection, and how do you prevent it?**
...
**Q: L4 When does chain-of-thought prompting fail?**
...
**Q: L4 What is the "lost in the middle" phenomenon, and how do you avoid it?**
...
**Q: L4 How do you get structured output without compromising reasoning?**
...
**Q: L4 How do you catch and recover from model version changes?**
...
**Q: L5 Why are prompt instructions more effective at the beginning or end?**
...
**Q: L5 How does recency bias affect few-shot example ordering?**
...
**Q: L5 How does self-consistency prompting work?**
...
**Q: L5 How does ReAct differ from chain-of-thought?**
...
**Q: L5 When is self-consistency worth the cost, and how do you reduce it?**
...
**Q: L5 Why does chain-of-thought fail on smaller models?**
...
**Q: L6 When should you chain prompts instead of using one large prompt?**
...
**Q: L6 How do you make prompt chains fault-tolerant?**
...
**Q: L6 RAG or few-shot prompting — which is better for knowledge tasks?**
...
**Q: L6 How do you support multiple languages in a single prompt?**
...
**Q: L6 Should you keep full conversation history or summarize periodically?**
...
**Q: L6 How do you test prompts in production?**
...
**Q: L6 What pitfalls should you watch for when A/B testing prompts?**
...
**Q: L7 Why do small prompt changes cause large output swings?**
...
**Q: L7 How do emergent capabilities affect multi-tier prompting?**
...
**Q: L7 Should you use automated tools for prompt optimization?**
...
**Q: L7 How do you prevent cascading hallucinations in multi-agent systems?**
...
**Q: L7 How do you design prompts for both high-quality and low-latency tiers?**
...
**Q: L7 How do you fix an infinite reasoning loop in ReAct?**
...
**Q: L7 As context windows grow, which prompting techniques will stay relevant?**
