...
Your task is to generate a comprehensive, progressive set of interview questions for the topic of Data Sending and Retrieval (HTTP / Networking).
...
- You are also free to add any area, concept, or question that a well-rounded understanding of Data Sending and Retrieval (HTTP / Networking) requires, even if not explicitly listed.
...
## Topic
Data Sending and Retrieval (HTTP / Networking)

---

## Output location

Save the generated question file to `prompts/3_output/questions/data_sending_and_retrieval.md`. If the folder does not exist, create it.
