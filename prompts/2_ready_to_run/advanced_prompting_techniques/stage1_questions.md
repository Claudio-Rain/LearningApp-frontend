...
Your task is to generate a comprehensive, progressive set of interview questions for the topic of Advanced Prompting Techniques for Generative AI.
...
- You are also free to add any area, concept, or question that a well-rounded understanding of Advanced Prompting Techniques for Generative AI requires, even if not explicitly listed.
...
## Topic
Advanced Prompting Techniques for Generative AI

---

## Output location

Save the generated question file to `prompts/3_output/questions/advanced_prompting_techniques.md`. If the folder does not exist, create it.
