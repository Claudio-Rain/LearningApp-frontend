...
Your task is to generate a comprehensive, progressive set of interview questions for the topic of Data Validation.
...
- You are also free to add any area, concept, or question that a well-rounded understanding of Data Validation requires, even if not explicitly listed.
...
Save the generated question file to `prompts/3_output/questions/data_validation.md`. If the folder does not exist, create it.
